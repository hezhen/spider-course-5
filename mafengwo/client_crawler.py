...
def parse_app_arguments():
    ...
    parser.add_argument('-h', '--host', type=str, nargs=1, help='Crawler host server address, default is localhost')
    ...
    parser.add_argument('-s', '--server', type=str, nargs=1, help='Server address for all services, including mongo, redis and spider')
    ...
    if args.server is not None:
        args.host = args.mongo = args.redis = args.server
